...
void	ft_create_image(t_map *game)
{
	...
	game->character = mlx_xpm_file_to_image(game->mlx, "textures/mage.xpm",
			&x, &y);
	game->wall = mlx_xpm_file_to_image(game->mlx, "textures/wall.xpm", &x, &y);
	game->land = mlx_xpm_file_to_image(game->mlx, "textures/land.xpm", &x, &y);
	game->ring = mlx_xpm_file_to_image(game->mlx, "textures/ring.xpm", &x, &y);
	game->door = mlx_xpm_file_to_image(game->mlx, "textures/closed_exit.xpm",
			&x, &y);
	game->o_door = mlx_xpm_file_to_image(game->mlx, "textures/open_exit.xpm",
			&x, &y);
...
void	ft_image_to_window(t_map *game, char slot, int x, int y)
{
	...
	mlx_string_put(game->mlx, game->win, 25, 25, 0x000000, "Steps Taken: ");
	mlx_string_put(game->mlx, game->win, 110, 25, 0x000000, str);
	free(str);
	if (slot == '1')
